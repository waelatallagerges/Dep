...
Use the following API functions to control your embedded DEP Meet Conference.
...
```json
{
  "rooms": [
    {
      "isMainRoom": true,
      "id": "room_name@conference.DEP",
      "jid": "room_name@conference.DEP/aaaaaa",
      "participants": [
        {
          "jid": "room_name@conference.DEP/bbbbbb",
          "role": "participant",
          "displayName": "p1",
          "id": "bbbbbb"
        },
        {
          "jid": "room_name@conference.DEP/cccccc",
          "role": "participant",
          "displayName": "p2",
          "id": "cccccc"
        }
    ...
    "jid": "aaaaaa-bbb-cccc-dddd-qwertyuiopas@breakout.DEP",
    "participants": [{
        "jid": "aaaaaa-cccc-dddd-eeee-qwertyuiopas@DEP/abcd1234",
        "role": "moderator",
...
Returns the IFrame HTML element which is used to load the DEP Meet conference:
...
Removes the embedded DEP Meet conference:

```javascript
api.dispose();
```

**NOTE:** DEP recommends removing the conference before the page is unloaded.
