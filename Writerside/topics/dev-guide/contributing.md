...
We prefer issues to be discussed first in the [community forum](https://community.DEP.org/) and when confirmed, then an issue can be opened in the [issue tracker](https://github.com/DEP/DEP-meet/issues).

When opening an issue, please provide as much information as possible. Mention the version of DEP Meet, Jicofo and JVB you are using, and explain (as detailed as you can) how the problem can be reproduced.

Please ask any general and implementation specific questions on the [community forum](https://community.DEP.org/) for support.

# Code contributions

Visit the [issue tracker](https://github.com/DEP/DEP-meet/issues) to find a list of open issues that need attention.

The [Developer Guide](developer-guide.) will help you to setup a development environment to start working on the DEP Meet applications.

## Contributor License Agreement
While the DEP projects are released under the
[Apache License 2.0](https://github.com/DEP/DEP-meet/blob/master/LICENSE), the copyright
holder and principal creator is [8x8](https://www.8x8.com/). To
ensure that we can continue making these projects available under an Open Source license,
we need you to sign our Apache-based contributor
license agreement as either a [corporation](https://DEP.org/ccla) or an
[individual](https://DEP.org/icla). If you cannot accept the terms laid out
...
* Sort by alphabetical order to make the addition of new entities as
  ...
  * JavaScript: Within an `import` of multiple names from a module, sort the names in
    ...
    import {
        ...
        DEP_CLIENT_CONNECTED,
        DEP_CLIENT_CREATED,
        DEP_CLIENT_DISCONNECTED,
        DEP_CLIENT_ERROR,
        DEP_CONFERENCE_JOINED,
        MODERATOR_CHANGED,
        PEER_JOINED,
        PEER_LEFT,
        RTC_ERROR
...
* An abstraction should have one name within the project and across multiple
  ...
  * The instance of lib-DEP-meet's `DEPConnection` type should be named
    `connection` or `DEPConnection` in DEP-meet, not `client`.
